...
FastAPI server for document Q&A using Azure AI Agents and ColPali.
...
from .agent import ColPaliAgent
...
agent: Optional[ColPaliAgent] = None
...
async def lifespan(app: FastAPI):
    ...
    try:
        logger.info("Initializing ColPali Agent...")
        agent = ColPaliAgent()
...
app = FastAPI(
    ...
    description="Document Q&A assistant using Azure AI Agents and ColPali2 for visual document retrieval",
    version="1.0.0",
    lifespan=lifespan,
)
