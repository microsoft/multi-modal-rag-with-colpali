...
module roleAssignmentsModule 'modules/roleAssignments.bicep' = {
  ...
  params: {
    ...
    aiFoundryProjectId: aiFoundryModule.outputs.aiProjectId
...
@description('The endpoint URL of the AI Foundry service')
output aiFoundryProjectEndpoint string = aiFoundryModule.outputs.aiFoundryProjectEndpoint

@description('The OpenAI endpoint URL of the AI Foundry service')
output aiFoundryOpenAiEndpoint string = aiFoundryModule.outputs.aiFoundryOpenAiEndpoint
